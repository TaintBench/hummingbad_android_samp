            ...
            if (types != null) {
                ...
                if (!isExact || type != 255) {
                    if (!isExact) {
                        ...
                        if (element != null && (element instanceof CacheRRset)) {
                            sr = new SetResponse(5, (CacheRRset) element);
                            break;
                        }
                    }
                    ...
                    if (element == null || !(element instanceof CacheRRset)) {
                        if (element == null) {
                            ...
                            if (element != null && (element instanceof CacheRRset)) {
                                sr = new SetResponse(4, (CacheRRset) element);
                                break;
                            }
                        }
                ...
                for (Element element2 : elements) {
                    if (element2.expired()) {
                        ...
                        sr.addRRset((CacheRRset) element2);
                        added++;
                    }
                }
                if (added > 0) {
                ...
                sr = new SetResponse(3, (CacheRRset) element2);
                break;
            }
            tlabels--;
        }
        sr = SetResponse.ofType(0);
        return sr;
    }
