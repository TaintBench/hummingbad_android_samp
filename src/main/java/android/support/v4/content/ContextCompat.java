...
public class ContextCompat {
    ...
    public static File[] getExternalFilesDirs(Context context, String type) {
        ...
        if (version >= 8) {
            ...
            single = buildPath(Environment.getExternalStorageDirectory(), "Android", "data", context.getPackageName(), DIR_FILES, type);
        }
        return new File[]{single};
    }
    ...
    public static File[] getExternalCacheDirs(Context context) {
        ...
        if (version >= 8) {
            ...
            single = buildPath(Environment.getExternalStorageDirectory(), "Android", "data", context.getPackageName(), DIR_CACHE);
        }
        return new File[]{single};
    }
