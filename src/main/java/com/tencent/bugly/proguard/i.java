...
public final class i {
    ...
    public i a(byte[] bArr, String str) {
        ...
        if (bArr == null) {
            ...
            this.a.append(bArr.length).append(", []").append(10);
        } else {
            this.a.append(bArr.length).append(", [").append(10);
    ...
    public i a(short[] sArr, String str) {
        ...
        if (sArr == null) {
            ...
            this.a.append(sArr.length).append(", []").append(10);
        } else {
            this.a.append(sArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (short a : sArr) {
    ...
    public i a(int[] iArr, String str) {
        ...
        if (iArr == null) {
            ...
            this.a.append(iArr.length).append(", []").append(10);
        } else {
            this.a.append(iArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (int a : iArr) {
    ...
    public i a(long[] jArr, String str) {
        ...
        if (jArr == null) {
            ...
            this.a.append(jArr.length).append(", []").append(10);
        } else {
            this.a.append(jArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (long a : jArr) {
    ...
    public i a(float[] fArr, String str) {
        ...
        if (fArr == null) {
            ...
            this.a.append(fArr.length).append(", []").append(10);
        } else {
            this.a.append(fArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (float a : fArr) {
    ...
    public i a(double[] dArr, String str) {
        ...
        if (dArr == null) {
            ...
            this.a.append(dArr.length).append(", []").append(10);
        } else {
            this.a.append(dArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (double a : dArr) {
    ...
    public <K, V> i a(Map<K, V> map, String str) {
        ...
        if (map == null) {
            ...
            this.a.append(map.size()).append(", {}").append(10);
        } else {
            this.a.append(map.size()).append(", {").append(10);
            i iVar = new i(this.a, this.b + 1);
    ...
    public <T> i a(T[] tArr, String str) {
        ...
        if (tArr == null) {
            ...
            this.a.append(tArr.length).append(", []").append(10);
        } else {
            this.a.append(tArr.length).append(", [").append(10);
            i iVar = new i(this.a, this.b + 1);
            for (Object a : tArr) {
