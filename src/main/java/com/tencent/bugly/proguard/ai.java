...
public class ai {
    ...
    public ai(Context context, b bVar, c cVar, a aVar, CrashHandleCallback crashHandleCallback) {
        this.a = context;
        this.b = bVar;
        this.c = cVar;
        this.d = aVar;
    ...
    public CrashDetailBean a(Thread thread, String str, String str2, String str3, Map<String, String> map) {
    ...
    public void b(Thread thread, String str, String str2, String str3, Map<String, String> map) {
        z.e("H5 Crash Happen", new Object[0]);
        try {
            if (!this.c.b()) {
            ...
            if (!d.d && this.c.b()) {
                ...
                CrashDetailBean a = a(thread, str, str2, str3, map);
                if (a == null) {
