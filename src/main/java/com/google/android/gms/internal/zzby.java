...
public final class zzby {
    ...
    public static final zzbu<Long> zzuY = zzbu.zzb("gads:device_info_caching_expiry_ms:expiry", 300000);
    ...
    public static final zzbu<Integer> zzuk = zzbu.zza("gads:video_stream_cache:limit_space", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
    public static final zzbu<Integer> zzul = zzbu.zza("gads:video_stream_exo_cache:buffer_size", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
    public static final zzbu<Long> zzum = zzbu.zzb("gads:video_stream_cache:limit_time_sec", 300);
    public static final zzbu<Long> zzun = zzbu.zzb("gads:video_stream_cache:notify_interval_millis", 1000);
    ...
    public static final zzbu<Long> zzur = zzbu.zzb("gads:video:metric_frame_hash_time_leniency", 500);
    ...
    public static final zzbu<Long> zzve = zzbu.zzb("gads:network:cache_prediction_duration_s", 300);
