...
public interface zzfn extends IInterface {

    public static abstract class zza extends Binder implements zzfn {

        private static class zza implements zzfn {
        ...
        public static zzfn zzP(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfn)) ? new zza(iBinder) : (zzfn) queryLocalInterface;
        }
