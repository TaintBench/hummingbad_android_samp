...
public class MobclickAgent {
    ...
    public static void onResume(Context context, String str, String str2) {
        if (context == null) {
            ...
            aj.b(a.e, "unexpected empty appkey in onResume");
        } else {
    ...
    public static void onEvent(Context context, String str, String str2, int i) {
        if (TextUtils.isEmpty(str2)) {
            aj.a(a.e, "label is null or empty");
        } else {
    ...
    public static void onEventDuration(Context context, String str, long j) {
        if (j <= 0) {
            aj.a(a.e, "duration is not valid in onEventDuration");
        } else {
    ...
    public static void onSocialEvent(Context context, String str, UMPlatformData... uMPlatformDataArr) {
        if (context == null) {
            aj.b(a.e, "context is null in onShareEvent");
            return;
        }
        e.e = "3";
    ...
    public static String getConfigParams(Context context, String str) {
        return f.a(context).g().getString(str, "");
    }
    ...
    public static void setUserID(Context context, String str, String str2, Gender gender, int i) {
        if (TextUtils.isEmpty(str)) {
            aj.c(a.e, "userID is null or empty");
            str = null;
        }
        if (TextUtils.isEmpty(str2)) {
            aj.a(a.e, "id source is null or empty");
            str2 = null;
        }
        if (i <= 0 || i >= CtaButton.WIDTH_DIPS) {
            aj.a(a.e, "not a valid age!");
            i = -1;
        }
